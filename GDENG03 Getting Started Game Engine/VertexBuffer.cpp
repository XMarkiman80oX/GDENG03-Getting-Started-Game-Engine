	...
	size_t size_byte_shader)
{
	...
	D3D11_INPUT_ELEMENT_DESC layout[] =
	{
		...
		{"POSITION", 1, DXGI_FORMAT_R32G32B32_FLOAT, 0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0}, // Corresponds to newPositionDistance
		{"COLOR",    0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 24, D3D11_INPUT_PER_VERTEX_DATA, 0}  // Corresponds to color
		// Removed: {"COLOR", 1, DXGI_FORMAT_R32G32B32_FLOAT, 0, 36, D3D11_INPUT_PER_VERTEX_DATA, 0} 
	};
...
{
	if (this->m_layout) this->m_layout->Release(); // Release layout first
	if (this->m_buffer) this->m_buffer->Release();
	delete this;
	return true;
}
