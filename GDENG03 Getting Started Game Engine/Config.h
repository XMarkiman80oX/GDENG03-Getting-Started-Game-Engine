...
struct Config
{
	...
	static const int NUMBER_OF_RANDOMIZED_CUBES = 10;
	static const bool RENDER_HOUSE_OF_CARDS = false;
	...
	static const bool ENABLE_WS_CUBE_ROTATION = true; //Enables the movement of the Cube via WASD (For Item #1)
	static const bool ENABLE_WARPING_ANIM = false; 
	static const bool ENABLE_INTERPOLATING_SCALE = false;
	static const cubeColor CUBE_COLOR = RAINBOW; //Selects the color of the cube to be rendered (USE THE GIVEN ENUM, 'cubeColor')
